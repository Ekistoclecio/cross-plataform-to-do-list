...
export class Default1693783639549 implements MigrationInterface {
    name = 'Default1693783639549'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "progressStatus" integer NOT NULL, "title" character varying(128) NOT NULL, "description" character varying, "priority" boolean NOT NULL, "deadline" date NOT NULL, "notificationStatus" integer NOT NULL, "notificationVisualization" boolean NOT NULL, "finishedDate" date, "isArchived" boolean NOT NULL, "User_id" uuid, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
